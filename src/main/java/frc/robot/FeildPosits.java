...
public final class FeildPosits {
    public static final class startingNotes{
        ...
        public static final Pose2d cornerStart = new Pose2d(0.5,2, new Rotation2d(0));
        ...
        public static final Pose2d farRightStartForPosits = new Pose2d(.5, 7.25, new Rotation2d(0));
    }
    public static final Pose2d ampScore = new Pose2d(1.5, 7.6, new Rotation2d(Math.toRadians(90)));
